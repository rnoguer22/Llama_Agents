...
If the answer is not found within the context, state that the answer cannot be found, but respond with your own knowledge.
...
# Funcion para quitar los links
def remove_links(text: str) -> str:
    url_pattern = r'https?://\S+|www\.\S+'
    return re.sub(url_pattern, '', text)

# Formateamos los documentos, añadiendo --- y quitando los links
...
# Tengo que ver que hacen estas funciones xd
...
# Esta tambien estoy cansado ahora jajaja
